...
public class CommandLineParser {
	...
	private static final String DEFAULT_ZOOKEEPER_CONNECT = "localhost:8088";
	private static final String DEFAULT_KAFKA_CONNECT = "localhost:8088";
	private static final String DEFAULT_MQTT_SERVER_URI = "tcp://localhost:8083";
	...
	@Option(name="--kfk", usage="Kafka connect string")
	private String kfkConnect = DEFAULT_KAFKA_CONNECT;

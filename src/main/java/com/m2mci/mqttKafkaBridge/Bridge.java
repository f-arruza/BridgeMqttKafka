...
public class Bridge implements MqttCallback {
	...
	private void connect(String serverURI, String clientId, String zkConnect, String kfkConnect) throws MqttException {
		...
		props.put("metadata.broker.list", kfkConnect);
	...
	public static void main(String args[]) {
		...
		try {
			...
			bridge.connect(parser.getServerURI(), parser.getClientId(), parser.getZkConnect(), parser.getKfkConnect());
